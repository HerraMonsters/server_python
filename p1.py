...
datve = {
    'pickupAddress':'Cầu Giấy', #điểm đi (máy hỏi địa điểm xuống, đồng thời xuất lịch trình các điểm đón trả)
    'takeoffAddress':'mình muốn xuống xe ở gia viễn', #điểm đến (máy hỏi thời gian đi, đồng thời xuất bảng thời gian xe xuất phát tại pickup_point)
    'time':'12 giờ kém 10 ', #thời gian khởi hành (máy hỏi ngày đi, đưa ra gợi ý về ngày khách tương tác hiện tại, ngày mai, ngày kia)
    'date':'ngày 12 tháng 1', #ngày đi (máy hỏi số ghế)
    'seats':'mình mua vé cho 11 người' #số ghế (máy tổng hợp lại thông tin tóm tắt cho khách)
}
req = 1
